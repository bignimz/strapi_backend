...
export interface ApiFamilyMemberFamilyMember extends Schema.CollectionType {
  ...
  attributes: {
    ...
    is_alive: Attribute.Boolean;
    date_of_death: Attribute.Date;
    place_of_birth: Attribute.String;
    occupation: Attribute.String;
    biographical_information: Attribute.RichText;
    children: Attribute.Relation<
      'api::family-member.family-member',
      'oneToMany',
      'api::family-member.family-member'
